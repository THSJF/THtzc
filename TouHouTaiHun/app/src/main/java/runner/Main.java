			...
			for (int index1 = 0;index1 < 4;++index1) {
				...
				if (str1.split(":")[1].split(",")[0] != "empty") {
					...
					for (int index2 = 0;index2 < num1;++index2) {
						...
						Batch batch = new Batch(Float.parseFloat(str2.split(",")[6]), Float.parseFloat(str2.split(",")[7]), Layer.LayerArray.get(Layer.LayerArray.size() - Layer.selection - 1).color);
						batch.id = Integer.parseInt(str2.split(",")[0]);
						batch.parentid = Integer.parseInt(str2.split(",")[1]);
						batch.Binding = (Boolean.parseBoolean(str2.split(",")[2]) ? 1 : 0) != 0;
						batch.bindid = Integer.parseInt(str2.split(",")[3]);
						batch.Bindwithspeedd = (Boolean.parseBoolean(str2.split(",")[4]) ? 1 : 0) != 0;
						batch.begin = Integer.parseInt(str2.split(",")[8]);
						batch.life = Integer.parseInt(str2.split(",")[9]);
						batch.fx = Float.parseFloat(str2.split(",")[10]);
						batch.fy = Float.parseFloat(str2.split(",")[11]);
						batch.r = Integer.parseInt(str2.split(",")[12]);
						batch.rdirection = Float.parseFloat(str2.split(",")[13]);
						...
						batch.type = Integer.parseInt(str2.split(",")[27]);
						batch.wscale = Float.parseFloat(str2.split(",")[28]);
						batch.hscale = Float.parseFloat(str2.split(",")[29]);
						batch.colorR = Integer.parseInt(str2.split(",")[30]);
						batch.colorG = Integer.parseInt(str2.split(",")[31]);
						batch.colorB = Integer.parseInt(str2.split(",")[32]);
						batch.alpha = Integer.parseInt(str2.split(",")[33]);
						...
						batch.Withspeedd = (Boolean.parseBoolean(str2.split(",")[36]) ? 1 : 0) != 0;
						...
						batch.Mist = (Boolean.parseBoolean(str2.split(",")[45]) ? 1 : 0) != 0;
						batch.Dispel = (Boolean.parseBoolean(str2.split(",")[46]) ? 1 : 0) != 0;
						batch.Blend = (Boolean.parseBoolean(str2.split(",")[47]) ? 1 : 0) != 0;
						batch.Afterimage = (Boolean.parseBoolean(str2.split(",")[48]) ? 1 : 0) != 0;
						batch.Outdispel = (Boolean.parseBoolean(str2.split(",")[49]) ? 1 : 0) != 0;
						batch.Invincible = (Boolean.parseBoolean(str2.split(",")[50]) ? 1 : 0) != 0;
						...
						while (true) {
							if (idx1 < str10.split("&").length - 1) {
								...
								_event.tag = str11.split("|")[0];
								_event.t = Integer.parseInt(str11.split("|")[1]);
								_event.addtime = Integer.parseInt(str11.split("|")[2]);
								int index3 = 0;
								while (true) {
									if (index3 < str11.split("|")[3].split(";").length - 1) {
										_event.events.add(str11.split("|")[3].split(";")[index3]);
										++index3;
									} else
										break;
								}
						...
						batch.rand.r = Integer.parseInt(str2.split(",")[55]);
						...
						if (str2.split(",").length >= 72) {
							batch.Cover = (Boolean.parseBoolean(str2.split(",")[70]) ? 1 : 0) != 0;
							batch.Rebound = (Boolean.parseBoolean(str2.split(",")[71]) ? 1 : 0) != 0;
							batch.Force = (Boolean.parseBoolean(str2.split(",")[72]) ? 1 : 0) != 0;
						}
						if (str2.split(",").length >= 74)
							batch.Deepbind = (Boolean.parseBoolean(str2.split(",")[73]) ? 1 : 0) != 0;
					...
					if (str1.split(":")[1].split(",").length >= 7) {
						...
						for (int index2 = 0;index2 < num2;++index2) {
							String str2 = streamReader.readLine();
							Lase lase = new Lase(Float.parseFloat(str2.split(",")[6]), Float.parseFloat(str2.split(",")[7]), Layer.LayerArray.get(Layer.LayerArray.size() - Layer.selection - 1).color);
							lase.id = Integer.parseInt(str2.split(",")[0]);
							lase.parentid = Integer.parseInt(str2.split(",")[1]);
							lase.Binding = (Boolean.parseBoolean(str2.split(",")[2]) ? 1 : 0) != 0;
							lase.bindid = Integer.parseInt(str2.split(",")[3]);
							lase.Bindwithspeedd = (Boolean.parseBoolean(str2.split(",")[4]) ? 1 : 0) != 0;
							lase.begin = Integer.parseInt(str2.split(",")[8]);
							lase.life = Integer.parseInt(str2.split(",")[9]);
							lase.r = Integer.parseInt(str2.split(",")[10]);
							lase.rdirection = Float.parseFloat(str2.split(",")[11]);
							...
							lase.type = Integer.parseInt(str2.split(",")[25]);
							lase.wscale = Float.parseFloat(str2.split(",")[26]);
							lase.longs = Float.parseFloat(str2.split(",")[27]);
							lase.alpha = Integer.parseInt(str2.split(",")[28]);
							lase.Ray = (Boolean.parseBoolean(str2.split(",")[29]) ? 1 : 0) != 0;
							...
							lase.Blend = (Boolean.parseBoolean(str2.split(",")[38]) ? 1 : 0) != 0;
							lase.Outdispel = (Boolean.parseBoolean(str2.split(",")[39]) ? 1 : 0) != 0;
							lase.Invincible = (Boolean.parseBoolean(str2.split(",")[40]) ? 1 : 0) != 0;
							...
							while (true) {
								if (idx1 < str9.split("&").length - 1) {
									...
									Event _event = new Event(idx1);
									_event.tag = str10.split("|")[0];
									_event.t = Integer.parseInt(str10.split("|")[1]);
									_event.addtime = Integer.parseInt(str10.split("|")[2]);
                            		int index3 = 0;
									while (true) {
										if (index3 < str10.split("|")[3].split(";").length - 1) {
											_event.events.add(str10.split("|")[3].split(";")[index3]);
											++index3;
										} else
											break;
									}
							...
							lase.rand.r = Integer.parseInt(str2.split(",")[44]);
							...
							if (str2.split(",").length >= 59)
								lase.Deepbind = (Boolean.parseBoolean(str2.split(",")[58]) ? 1 : 0) != 0;
							Layer.LayerArray.get(index1).LaseArray.add(lase);
						}
						int num3 = Integer.parseInt(str1.split(":")[1].split(",")[5]);
						for (int index2 = 0;index2 < num3;++index2) {
							String str2 = streamReader.readLine();
							Cover cover = new Cover(Float.parseFloat(str2.split(",")[2]), Float.parseFloat(str2.split(",")[3]), Layer.LayerArray.get(Layer.LayerArray.size() - Layer.selection - 1).color);
							cover.id = Integer.parseInt(str2.split(",")[0]);
							cover.parentid = Integer.parseInt(str2.split(",")[1]);
							cover.begin = Integer.parseInt(str2.split(",")[4]);
							cover.life = Integer.parseInt(str2.split(",")[5]);
							cover.halfw = Integer.parseInt(str2.split(",")[6]);
							cover.halfh = Integer.parseInt(str2.split(",")[7]);
							cover.Circle = (Boolean.parseBoolean(str2.split(",")[8]) ? 1 : 0) != 0;
							cover.type = Integer.parseInt(str2.split(",")[9]);
							cover.controlid = Integer.parseInt(str2.split(",")[10]);
							cover.speed = Float.parseFloat(str2.split(",")[11]);
							cover.speedd = Float.parseFloat(str2.split(",")[12]);
							...
							while (true) {
								if (idx1 < str5.split("&").length - 1) {
									...
									Event _event = new Event(idx1);
									_event.tag = str6.split("|")[0];
									_event.t = Integer.parseInt(str6.split("|")[1]);
									_event.addtime = Integer.parseInt(str6.split("|")[2]);
									int index3 = 0;
									while (true) {
										if (index3 < str6.split("|")[3].split(";").length - 1) {
											_event.events.add(str6.split("|")[3].split(";")[index3]);
											++index3;
										} else
											break;
									}
							...
							if (str2.split(",").length >= 25) {
								if (str2.split(",")[24] != "")
									cover.Deepbind = (Boolean.parseBoolean(str2.split(",")[24]) ? 1 : 0) != 0;
							}
						...
						for (int index2 = 0;index2 < num4;++index2) {
							String str2 = streamReader.readLine();
							Rebound rebound = new Rebound(Float.parseFloat(str2.split(",")[2]), Float.parseFloat(str2.split(",")[3]), Layer.LayerArray.get(Layer.LayerArray.size() - Layer.selection - 1).color);
							rebound.id = Integer.parseInt(str2.split(",")[0]);
							rebound.parentid = Integer.parseInt(str2.split(",")[1]);
							rebound.begin = Integer.parseInt(str2.split(",")[4]);
							rebound.life = Integer.parseInt(str2.split(",")[5]);
							rebound.longs = Integer.parseInt(str2.split(",")[6]);
							rebound.angle = Integer.parseInt(str2.split(",")[7]);
							rebound.time = Integer.parseInt(str2.split(",")[8]);
							rebound.speed = Float.parseFloat(str2.split(",")[9]);
							rebound.speedd = Float.parseFloat(str2.split(",")[10]);
							rebound.aspeed = Float.parseFloat(str2.split(",")[11]);
							rebound.aspeedd = Float.parseFloat(str2.split(",")[12]);
						...
						for (int index2 = 0;index2 < num5;++index2) {
							String str2 = streamReader.readLine();
							Force f= new Force(Float.parseFloat(str2.split(",")[2]), Float.parseFloat(str2.split(",")[3]), Layer.LayerArray.get(Layer.LayerArray.size() - Layer.selection - 1).color);
							f.id = Integer.parseInt(str2.split(",")[0]);
							f.parentid = Integer.parseInt(str2.split(",")[1]);
							f.begin = Integer.parseInt(str2.split(",")[4]);
							f.life = Integer.parseInt(str2.split(",")[5]);
							f.halfw = Integer.parseInt(str2.split(",")[6]);
							f.halfh = Integer.parseInt(str2.split(",")[7]);
							f.Circle = (Boolean.parseBoolean(str2.split(",")[8]) ? 1 : 0) != 0;
							f.type = Integer.parseInt(str2.split(",")[9]);
							f.controlid = Integer.parseInt(str2.split(",")[10]);
							f.speed = Float.parseFloat(str2.split(",")[11]);
							f.speedd = Float.parseFloat(str2.split(",")[12]);
							f.aspeed = Float.parseFloat(str2.split(",")[13]);
							f.aspeedd = Float.parseFloat(str2.split(",")[14]);
							f.addaspeed = Float.parseFloat(str2.split(",")[15]);
							f.addaspeedd = Float.parseFloat(str2.split(",")[16]);
							f.Suction = (Boolean.parseBoolean(str2.split(",")[17]) ? 1 : 0) != 0;
							f.Repulsion = (Boolean.parseBoolean(str2.split(",")[18]) ? 1 : 0) != 0;
							f.addspeed = Float.parseFloat(str2.split(",")[19]);
							f.rand = new Force();
							f.rand.speed = Float.parseFloat(str2.split(",")[20]);
							f.rand.speedd = Float.parseFloat(str2.split(",")[21]);
							f.rand.aspeed = Float.parseFloat(str2.split(",")[22]);
							f.rand.aspeedd = Float.parseFloat(str2.split(",")[23]);
