...
import runner.*;
    ...
    public class Batch {
        ...
        public void Update() {
            ...
            if(this.bindid!=-1&&this.bindid>=Layer.LayerArray.get(parentid).BatchArray.size()) {
                this.bindid=-1;
                this.Deepbind=false;
                this.Bindwithspeedd=false;
            }
            ...
            if(!this.Deepbind) {
                ...
                this.conditions[5]=this.tiao;
                this.conditions[6]=this.t;
                this.conditions[7]=this.fdirection;
                this.conditions[8]=this.range;
                ...
                this.results[4]=this.tiao;
                this.results[5]=this.t;
                        ...
                        if(result.opreator==">") {
                            if(result.opreator2==">") {
                                if(result.collector=="且") {
                                    if(this.conditions[result.contype]>Double.parseDouble(result.condition)+(parentevent.loop*parentevent.addtime)&(double)this.conditions[result.contype2]>(double)Float.parseFloat(result.condition2)+(double)(parentevent.loop*parentevent.addtime)) {
                                        if(result.special==1)
                                            this.Recover();
                                            ...
                                            if(!result.noloop) {
                                                ...
                                                execution.region=String.valueOf(this.results[result.changename]);
                                ...
                                } else if(result.collector=="或"&&((double)this.conditions[result.contype]>Double.parseDouble(result.condition)+(parentevent.loop*parentevent.addtime)||(double)this.conditions[result.contype2]>(double)Float.parseFloat(result.condition2)+(double)(parentevent.loop*parentevent.addtime))) {
                                    if(result.special==1)
                                        this.Recover();
                                    else if(result.special==2) {
                                        this.Shoot();
                                        ...
                                        if(!result.noloop) {
                                            ...
                                            execution.changevalue=result.changevalue;
                                            execution.value=(double)result.rand==0.0 ? result.res : result.res+MathHelper.Lerp(-result.rand,result.rand,(float)Main.rand.NextDouble());
                                            execution.region=this.results[result.changename]+"";
                                            execution.time=result.times;
                                            execution.ctime=execution.time;
                                            this.Eventsexe.add(execution);
                                        } else
                                ...
                                } else if(result.collector=="或"&&((double)this.conditions[result.contype]>(double)Float.parseFloat(result.condition)+(double)(parentevent.loop*parentevent.addtime)||(double)this.conditions[result.contype2]==(double)Float.parseFloat(result.condition2)+(double)(parentevent.loop*parentevent.addtime))) {
                                    if(result.special==1)
                                        this.Recover();
                                    else if(result.special==2) {
                                        this.Shoot();
                ...
                for(int index = 0;index<this.Eventsexe.size();++index) {
                    if(!this.Eventsexe.get(index).NeedDelete) {
                        this.Eventsexe.get(index).Update(this);
                    } else {
