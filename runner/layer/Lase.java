...
public class Lase implements Cloneable {
        public int bindid = -1;
        ...
        public Lase BindClone() {
            ...
            for(Event parentevent : Parentevents)
                lase.Parentevents.add(parentevent.Clone());
            ...
            for(Event sonevent : Sonevents)
                lase.Sonevents.add(sonevent.Clone());
            return lase;
        }

        public Lase Clone() {
			try {
				Lase batch=(Lase)super.clone();
