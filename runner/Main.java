...
public class Main {
        ...
        public static Texture barrages;
        public static Texture barrages2;
        public static Texture mist;
                ...
                if(source.contains("GlobalEvents")) {
                    ...
                    for(int index = 0;index<num1;++index) {
                        ...
                        GlobalEvent globalEvent = new GlobalEvent {
                            ...
                            isgoto=(boolean.Parse(str.split("_")[4]) ? 1 : 0)!=0,
                            ...
                            isquake=(boolean.Parse(str.split("_")[10]) ? 1 : 0)!=0,
                            ...
                            isstop=(boolean.Parse(str.split("_")[16]) ? 1 : 0)!=0,
                    ...
                    if(str1.split(":")[1].split(",")[0]!="empty") {
                        ...
                        for(int index2 = 0;index2<num1;++index2) {
                            ...
                            Batch batch = new Batch(Float.parseFloat(str2.split(",")[6]),Float.parseFloat(str2.split(",")[7]),Layer.LayerArray[Layer.LayerArray.size()-Layer.selection-1].color) {
                                ...
                                Binding=(boolean.Parse(str2.split(",")[2]) ? 1 : 0)!=0,
                                bindid=Integer.parseInt(str2.split(",")[3]),
                                Bindwithspeedd=(boolean.Parse(str2.split(",")[4]) ? 1 : 0)!=0,
                            ...
                            batch.Withspeedd=(boolean.Parse(str2.split(",")[36]) ? 1 : 0)!=0;
                            ...
                            batch.Mist=(boolean.Parse(str2.split(",")[45]) ? 1 : 0)!=0;
                            batch.Dispel=(boolean.Parse(str2.split(",")[46]) ? 1 : 0)!=0;
                            batch.Blend=(boolean.Parse(str2.split(",")[47]) ? 1 : 0)!=0;
                            batch.Afterimage=(boolean.Parse(str2.split(",")[48]) ? 1 : 0)!=0;
                            batch.Outdispel=(boolean.Parse(str2.split(",")[49]) ? 1 : 0)!=0;
                            batch.Invincible=(boolean.Parse(str2.split(",")[50]) ? 1 : 0)!=0;
                            ...
                            if(str2.split(",").Length>=72) {
                                batch.Cover=(boolean.Parse(str2.split(",")[70]) ? 1 : 0)!=0;
                                batch.Rebound=(boolean.Parse(str2.split(",")[71]) ? 1 : 0)!=0;
                                batch.Force=(boolean.Parse(str2.split(",")[72]) ? 1 : 0)!=0;
                            }
                            if(str2.split(",").Length>=74)
                                batch.Deepbind=(boolean.Parse(str2.split(",")[73]) ? 1 : 0)!=0;
                        ...
                        if(str1.split(":")[1].split(",").Length>=7) {
                            ...
                            for(int index2 = 0;index2<num2;++index2) {
                                ...
                                lase.Ray=(boolean.Parse(str2.split(",")[29]) ? 1 : 0)!=0;
                                ...
                                lase.Blend=(boolean.Parse(str2.split(",")[38]) ? 1 : 0)!=0;
                                lase.Outdispel=(boolean.Parse(str2.split(",")[39]) ? 1 : 0)!=0;
                                lase.Invincible=(boolean.Parse(str2.split(",")[40]) ? 1 : 0)!=0;
                                ...
                                if(str2.split(",").Length>=59)
                                    lase.Deepbind=(boolean.Parse(str2.split(",")[58]) ? 1 : 0)!=0;
                            ...
                            for(int index2 = 0;index2<num3;++index2) {
                                ...
                                Cover cover = new Cover(Float.parseFloat(str2.split(",")[2]),Float.parseFloat(str2.split(",")[3]),Layer.LayerArray[Layer.LayerArray.size()-Layer.selection-1].color) {
                                    ...
                                    Circle=(boolean.Parse(str2.split(",")[8]) ? 1 : 0)!=0,
                                ...
                                if(str2.split(",").Length>=25) {
                                    if(str2.split(",")[24]!="")
                                        cover.Deepbind=(boolean.Parse(str2.split(",")[24]) ? 1 : 0)!=0;
                                }
                            ...
                            for(int index2 = 0;index2<num5;++index2) {
                                ...
                                Layer.LayerArray[index1].ForceArray.put(new Force(Float.parseFloat(str2.split(",")[2]),Float.parseFloat(str2.split(",")[3]),Layer.LayerArray[Layer.LayerArray.size()-Layer.selection-1].color) {
                                    ...
                                    Suction=(boolean.Parse(str2.split(",")[17]) ? 1 : 0)!=0,
                                    Repulsion=(boolean.Parse(str2.split(",")[18]) ? 1 : 0)!=0,
